      ...
      <div class="tab-pane mb-3" id="account-orders">
        ...
        <table class=" table  table-hover shop-table account-orders-table mb-6">
          ...
          <tbody class="table-hover fetch_orderdatas" style="text-align: center;">
            ...
            // echo $user_id;
            $sql = "SELECT * FROM  wishlist  LEFT JOIN product_details  ON wishlist.product_id = product_details.product_id  WHERE wishlist.user_id=$user_id";
            //    echo $sql;
            $result = $db->query($sql);
            ...
            ?>
              <tr>
                ...
                <td style="padding-right: 108px;"> <a href="javascript:void();" id="<?php echo $product_id; ?>" name="add" style="cursor:pointer" data-product-id=<?php echo $product_id; ?> class="add_to_cart add<?php echo $product_id; ?> primary-btn button">Add To Cart</a></td>
              </tr>
            <?php } ?>
          </tbody>
        </table>
