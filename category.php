...
<nav class="navbar navbar-expand-sm navbar-light bg-white border-bottom bid">
    ...
    <?php
    $sc_id = $_GET['cat_id'];
    $sql = "SELECT * FROM `category` WHERE `category_id`='$sc_id'";
    //    echo $sql;
    $result = $db->query($sql);
    ...
    ?>
        <h1 style="margin-right: 600px;font-size:px;"><?php echo $category_name; ?></h1><?php } ?>
    <style>
        /* <style>
        .container h1::before {
...
<div class="product-con">
    ...
    <section id="products" class="pro-con">
        <div class="list-pro">
            ...
            $sql = "SELECT * FROM `product_details` WHERE `category_name`='$sc_id' AND `status` = 'approved' AND `balanced_stock`!=0";
            $result = $db->query($sql);
                        ...
                        <div class="product-content">
                            ...
                            <div class="product-detail">
                                ...
                                <ul>
                                    ...
                                    <li>Shipping Area: <span><b class="free"></b></span>
                                    <li>
