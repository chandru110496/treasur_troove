            ...
            <div class="card-wrapper">
                <div class="card" style="min-width:95%;border:none;">
                    ...
                    <div class="one">
                        ...
                        <div class="product-content">
                            ...
                            <form action="submit_rating.php" method="POST">
                                ...
                                <!-- submit rate ths product -->
                                <br>
                                <button class="btn btn-primary" type="submit" value="Submit Rating" name="submit_rating">Submit</button>
                            </form>
                    ...
                    <div class="social-links">
                        <div class="ss">
                            <?php $product_url = "https://treasuretroove.teckzy.co.in/buy.php"; ?>
                            ...
                            <a href="https://www.instagram.com/share?url=<?php echo urlencode($product_url); ?>" target="_blank">
                                <img src="assets/images/instagram.png" alt="Share on Instagram">
                            </a>
                            <a href="https://api.whatsapp.com/send?text=<?php echo urlencode($product_url); ?>" target="_blank">
                                <img src="assets/images/whatsapp.png" alt="Share on WhatsApp">
                            </a>
                            <a href="mailto:?subject=Check%20out%20this%20page&body=<?php echo urlencode($product_url); ?>">
                                <img src="assets/images/email.png" alt="Share via Email">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        $(".card-img-top").click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (rec.rates == null || rec.rates == "" || rec.rates == 0) {
                        rec.rates = 3.0000;
                    }
                    ...
                    $(".rating").text(rec.rates);
                    $(".total_rating").text(rec.total_rating);
