                ...
                <ul id="side" class="nav navbar-nav side-nav">
                    ...
                    <li class="side-user hidden-xs">
                        ...
                        <p class="name tooltip-sidebar-logout">
                            <?php echo $_SESSION['admin_name'] ?> <span class="last-name"></span> <a style="color: inherit" class="logout_open" href="#logout" data-toggle="tooltip" data-placement="top" title="Logout"><i class="fa fa-sign-out"></i></a>
                        </p>
                    ...
                    <?php if ($_SESSION['type'] == 'admin') { ?>
                        ...
                        <li>
                            <a class="" href="Vendors.php">
                                <i class="fa fa-user"></i>Vendors List
                            </a>
                        </li>
                    <?php } ?>
                    ...
                    <li class="panel">
                        ...
                        <ul class="collapse nav" id="cs">
                            <li>
                                <a href="javascript:;" data-parent="#sid" data-toggle="collapse" class="accordion-toggle" data-target="#bd">
                            ...
                            <li>
                                <a href="javascript:;" data-parent="#sid" data-toggle="collapse" class="accordion-toggle" data-target="#buy">
                    ...
                    <li class="panel">
                        <a href="javascript:;" data-parent="#side" data-toggle="collapse" class="accordion-toggle" data-target="#css">
                    ...
                    <li class="panel">
                        <a class="" href="javascript:;" data-parent="#side" data-toggle="collapse" class="accordion-toggle" data-target="#cssss">
