    ...
    <section id="products" class="pro-con">
        <div class="container">
            ...
            <div class="row">
                ...
                $sql = "SELECT * FROM `deal_product_details` LEFT JOIN `service_provider` ON `service_provider`.`user_id` = `deal_product_details`.`deal_vendor_id` WHERE `deal_product_details`.`expiry_time` > '$current_time' ORDER BY `deal_product_details`.`deal_close` ASC";
                //    echo $sql;
                $result = $db->query($sql);
                // print_r($result);
                ...
                ?>
                    ...
                    <div class="col">
                        <div id="card<?php echo $deal_id ?>" class="card">
                            ...
                            <img class="card-img-top" data-proId="<?php echo $deal_id ?>" style="object-fit:cover;" src="./upload/deal/<?php echo $deal_image; ?>" alt="Card image cap">
                            <div class="card-body">
                                <B>
                                ...
                                <form action="mk_deal.php" method="POST">
                                    ...
                                    <?php } ?>
                                    <input type="text" name="amount" placeholder="Enter Amount" style="width:100px;margin-bottom: 10px;height:28px;border: 1px solid #185474;"><br>
                                    <!-- <p>Final Offer</p>
                            <h6>$5</h6> -->
                                    <?php if (isset($_SESSION['s_provider'])) { ?>
                                        <button type="submit" id="dealbtn" name="mk_deal" class="btn btn-warning btn-lg btn_grad_blgr w-50 text-truncate mt-auto" style="border-radius: 15px; padding: 6px 31px;">Deal</button>
                                    <?php } else { ?>
                                        <button type="button" style="text-align: center;padding-left: 32px;" class="btn btn-warning btn-lg btn_grad_blgr w-50 text-truncate mt-auto" onclick="showAlertss()">Deal</button>
                            ...
                            style="margin-bottom:3px;display:grid;place-items:center;">Last Deal:<b><?php echo $deal_price ?></b><img
                                ...
                                <a href="#" class="dealers" data-proId="<?php echo $deal_id ?>" id="openPopupButton<?php echo $deal_id; ?>"><button class="btn btn-info" style=" margin-top: 17px;border-radius:50px;font-size:12px;color:whitesmoke;background-color:#32919d">View Deals</button></a>
